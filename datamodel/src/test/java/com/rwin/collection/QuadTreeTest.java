...
public class QuadTreeTest extends junit.framework.TestCase {
    ...
    public void testSearchIntersects() {
        QuadTree qt = getTree();
        List arr = qt.searchIntersect(4, 0, 51, 98);
        Point[] points = (Point[]) arr.toArray(new Point[arr.size()]);
        Arrays.sort(points);
        ...
        arr = qt.searchIntersect(5, 0, 50, 96);
        Point[] points2 = (Point[]) arr.toArray(new Point[arr.size()]);
        ...
        arr =qt.searchIntersect(55, 0, 50, 96);
         Point[] points3 = (Point[]) arr.toArray(new Point[arr.size()]);
    ...
    public void testSearchWithin() {
        QuadTree qt = getTree();
        List arr = qt.searchWithin(4, -1, 51, 98);
        Point[] points = (Point[]) arr.toArray(new Point[arr.size()]);
